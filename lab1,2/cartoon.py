...
def cartoon():
    ...
    cr.draw(win)
    cr_eL= Circle(Point(45,20),3)# left eye
    cr_eL.draw(win)
    cr_eR= Circle(Point(65,20),3)# right eye
    cr_eR.draw(win)
    mouth = Line(Point(60,45),Point(50,45))# mouth
    mouth.draw(win)
    ln1 = Line(Point(50,48),Point(50,66))#neck 1
    ln1.draw(win)
    ln2 = Line(Point(60,48),Point(60,66))# neck 2
    ln2.draw(win)
    rect = Rectangle(Point(40,66),Point(70,116))#body
    rect.draw(win)
